...
Our database will be a single sqlite database called `words.db` that will be in the root of the project folder

We have the following tables:
- words - stored vocabulary words
  - id integer
  - latin_spelling string
  - origin_language string 
  - arabic_spelling string or null
  - english string
