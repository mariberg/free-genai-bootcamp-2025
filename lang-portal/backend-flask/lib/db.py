...
class Db:
    ...
    def import_word_json(self, cursor, group_name, data_json_path):
        ...
        for word in words:
            ...
            cursor.execute('''
                INSERT INTO words (latin_spelling, origin_language, arabic_spelling, english) VALUES (?, ?, ?, ?)
            ''', (word['latin_spelling'], word['origin_language'], word['arabic_spelling'], word['english']))
